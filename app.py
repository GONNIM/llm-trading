...
st.set_page_config(
    page_title="자동매매 시스템 - MACD, EMA", page_icon="📈", layout="wide"
)

st.title("📊 업비트 자동매매 백테스트 - MACD, EMA")
...
with st.sidebar:
    ...
    with st.form("input_form"):
        ...
        stop_loss = st.number_input("Stop Loss (%)", 0.1, 50.0, 3.0, 0.1) / 100
        cash = st.number_input(
            "초기 자본 (원)", 1_000_000, 100_000_000_000, 100_000_000
        )
